...
function dismissRecommendation( uiIndex, storeId, post ) {
	stats.recordTrackForPost( 'calypso_reader_in_stream_rec_dismissed', post, { ui_position: uiIndex } );
	stats.recordAction( 'in_stream_rec_dismiss' );
	dismissPost( storeId, post );
}

function handleSiteClick( uiIndex, post ) {
	stats.recordTrackForPost( 'calypso_reader_in_stream_rec_site_clicked', post, { ui_position: uiIndex } );
	stats.recordAction( 'in_stream_rec_site_click' );
}

function handlePostClick( uiIndex, post ) {
	stats.recordTrackForPost( 'calypso_reader_in_stream_rec_post_clicked', post, { ui_position: uiIndex } );
